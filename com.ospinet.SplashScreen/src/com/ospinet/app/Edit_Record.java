...
public class Edit_Record extends Activity implements ISideNavigationCallback {
	String recId;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		dialog = new ProgressDialog(Edit_Record.this);
	...
	public void Edit_Record(View v) {
		if (edtTitle.getText().toString().equals("")) {
			...
			Toast.makeText(Edit_Record.this, "Please enter title",
		...
		protected void onPostExecute(String sJson) {
			...
			try {
				...
				if (sJson.contains("\"success\":1")) {
					Toast.makeText(Edit_Record.this,
							"Record updated successfully", Toast.LENGTH_LONG)
							.show();
					Intent i = new Intent(Edit_Record.this, RecordsList.class);
					i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
					i.putExtra("member_id", memid);
					i.putExtra("EXIT", true);

					Edit_Record.this.startActivity(i);
					// finish();
				} else {
					Toast.makeText(Edit_Record.this,
	...
	public void cancel(View v) {
		Intent intent = new Intent(Edit_Record.this, RecordsList.class);
		intent.putExtra("EXIT", true);
		Edit_Record.this.startActivity(intent);
    ...
    imgLogo.setOnClickListener(new OnClickListener() {
    	...
    	public void onClick(View v) {
    		// TODO Auto-generated method stub
    		Intent i = new Intent(Edit_Record.this,PreMemberHome.class);
            ...
            public void onSideNavigationItemClick(int itemId) {
                switch(itemId)
                {
                    case R.id.side_navigation_menu_item1:
                        Intent i = new Intent(Edit_Record.this, LoginActivity.class);
                        i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                        i.putExtra("EXIT", true);
                    ...
                    case R.id.side_navigation_menu_item2:
                        Intent records = new Intent(Edit_Record.this, Member_Home.class);
                        Edit_Record.this.startActivity(records);

                        break;

                    case R.id.side_navigation_menu_item3:
                        Intent help = new Intent(Edit_Record.this, help.class);
                        Edit_Record.this.startActivity(help);

                        break;

                    case R.id.side_navigation_menu_item4:
                        Intent home = new Intent(Edit_Record.this, PreMemberHome.class);
                        Edit_Record.this.startActivity(home);

                        break;

                    case R.id.side_navigation_menu_item5:
                        Intent share = new Intent(Edit_Record.this, ShareMainActivity.class);
                        Edit_Record.this.startActivity(share);

                        break;

                    case R.id.side_navigation_menu_item6:
                        Intent search = new Intent(Edit_Record.this, SearchMainActivity.class);
                        Edit_Record.this.startActivity(search);
